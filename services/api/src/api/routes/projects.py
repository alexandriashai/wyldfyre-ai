...
async def create_project(
    ...
    project = Project(
        ...
        terminal_user=request.terminal_user,
        color=request.color,
        icon=request.icon,
        user_id=current_user.sub,
        # Docker settings
        docker_enabled=request.docker_enabled,
        docker_project_type=request.docker_project_type,
        docker_node_version=request.docker_node_version,
        docker_php_version=request.docker_php_version,
        docker_python_version=request.docker_python_version,
        docker_memory_limit=request.docker_memory_limit,
...
async def get_project(
    ...
    return ProjectWithStatsResponse(
        ...
        terminal_user=project.terminal_user,
        ...
        docker_project_type=project.docker_project_type,
        docker_node_version=project.docker_node_version,
        docker_php_version=project.docker_php_version,
        docker_python_version=project.docker_python_version,
        docker_memory_limit=project.docker_memory_limit,
        docker_cpu_limit=project.docker_cpu_limit,
