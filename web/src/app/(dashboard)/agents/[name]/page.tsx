    ...
    <div className="p-6">
      ...
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-center gap-4">
          <div className={cn("rounded-xl p-3", getAgentBgColor(selectedAgent.name as AgentType))}>
            <Bot className={cn("h-8 w-8", getAgentColor(selectedAgent.name as AgentType))} />
          </div>
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <div
                className={cn(
                  ...
                  getStatusBgColor(selectedAgent.status as AgentStatus)
                )}
              />
              <span className={cn("text-sm capitalize", getStatusColor(selectedAgent.status as AgentStatus))}>
