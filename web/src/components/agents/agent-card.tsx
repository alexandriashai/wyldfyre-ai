...
import { cn, getStatusColor, getStatusBgColor, getAgentColor, formatRelativeTime } from "@/lib/utils";
      ...
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={cn("rounded-lg p-2", `${getAgentColor(agent.name).replace("text-", "bg-")}/10`)}>
              <Bot className={cn("h-5 w-5", getAgentColor(agent.name))} />
            </div>
            <div>
