          ...
          <TableRow key={domain.id}>
            ...
            <TableCell>
              <div className="flex items-center gap-1">
                <Lock className={cn("h-3 w-3", domain.ssl_status === "active" ? "text-green-500" : "text-muted-foreground")} />
                <Badge variant="outline" className={cn(sslStatusColors[domain.ssl_status])}>
                  {domain.ssl_status}
                </Badge>
              </div>
            </TableCell>
